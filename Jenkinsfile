pipeline{
  ...
  stages {
    ...
    steps {
      sshagent(['tomcat2']) {
         sh 'scp -i /var/lib/jenkins/jenkins2.pem -o StrictHostKeyChecking=no target/*.war ubuntu@13.127.106.153:/home/ubuntu/prod/apache-tomcat-10.0.22/webapps/webapp.war'
      }
    }
  }
  }
